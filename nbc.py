...
def nbcMain(train_data_file, test_data_file):
    if len(sys.argv) != 30:
...
# for i in [100, 300, 500, 700, 900, 1100, 1300, 1500, 1700]:
#     train_data_file = "Sc01_" + str(i) +".dat"
#     test_data_file = "S01.dat"
#     main(train_data_file, test_data_file)
